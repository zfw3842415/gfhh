    ...
    $(function () {
        ...
        $.initJSNForm = function (formname) {
            ...
            function calculateTotal() {
                ...
                var listElements = $(formname).find("select.list.htm"/*tpa=http://demo.jlvextension.com/carservice/components/com_uniform/assets/js/select.list*/);
            ...
            $(formname).find("input").keypress(function (e) {
                if (e.which == 13 && $(".jsn-modal-overlay").size() < 1) {
                    if ($(formname).find("button.next.htm"/*tpa=http://demo.jlvextension.com/carservice/components/com_uniform/assets/js/button.next*/).hasClass("hide")) {
                        $(formname).find("button.jsn-form-submit").click();
                    } else {
                        $(formname).find("button.next.htm"/*tpa=http://demo.jlvextension.com/carservice/components/com_uniform/assets/js/button.next*/).click();
                    }
                    return false;
                }
            });
            ...
            var randomizeListGroups = $(formname).find('select.list.htm'/*tpa=http://demo.jlvextension.com/carservice/components/com_uniform/assets/js/select.list*/);
            ...
            $(formname).find("select.list.htm"/*tpa=http://demo.jlvextension.com/carservice/components/com_uniform/assets/js/select.list*/).change(calculateTotal);
                ...
                Recaptcha.create(publickey, idcaptcha, {
                    ...
                    callback:function () {
                        ...
                        $(form).find("#recaptcha_response_field").keypress(function (e) {
                            if (e.which == 13) {
                                if ($(form).find("button.next.htm"/*tpa=http://demo.jlvextension.com/carservice/components/com_uniform/assets/js/button.next*/).hasClass("hide")) {
                                    $(form).find("button.jsn-form-submit").click();
                                } else {
                                    $(form).find("button.next.htm"/*tpa=http://demo.jlvextension.com/carservice/components/com_uniform/assets/js/button.next*/).click();
                                }
                                return false;
                            }
                        });
