...
+function ($) {
  ...
  SPPBTab.prototype.show = function () {
    ...
    var e        = $.Event('show.sppb.tab.htm'/*tpa=http://demo.jlvextension.com/carservice/components/com_sppagebuilder/assets/js/show.sppb.tab*/, {
    ...
    this.activate($target, $target.parent(), function () {
      $this.trigger({
        type: 'shown.sppb.tab.htm'/*tpa=http://demo.jlvextension.com/carservice/components/com_sppagebuilder/assets/js/shown.sppb.tab*/,
        relatedTarget: previous
      })
    })
  }
  ...
  function Plugin(option) {
    return this.each(function () {
      var $this = $(this)
      var data  = $this.data('sppb.tab.htm'/*tpa=http://demo.jlvextension.com/carservice/components/com_sppagebuilder/assets/js/sppb.tab*/)

      if (!data) $this.data('sppb.tab.htm'/*tpa=http://demo.jlvextension.com/carservice/components/com_sppagebuilder/assets/js/sppb.tab*/, (data = new SPPBTab(this)))
...
+function ($) {
  ...
  if (!$.fn.sppbtooltip) throw new Error('Popover requires tooltip.js'/*tpa=http://demo.jlvextension.com/carservice/components/com_sppagebuilder/assets/js/Popover requires tooltip.js*/)
